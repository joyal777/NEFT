...
('joyal@gmail.com|127.0.0.1', 'i:1;', 1736402575),
('joyal@gmail.com|127.0.0.1:timer', 'i:1736402575;', 1736402575);
...
(1, 'test', 'test@gmail.com', NULL, '$2y$12$THFt.0NMuIM4gN.b7i6KNOL8xz/bCWch5wMab4RvKozR0moitN.Vy', NULL, '2025-01-09 00:32:30', '2025-01-09 00:32:30');
...
ALTER TABLE `property`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_property_cat_id` (`cat_id`),
...
--
ALTER TABLE `property`
  ADD CONSTRAINT `FK_property_cat_id` FOREIGN KEY (`cat_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_property_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
